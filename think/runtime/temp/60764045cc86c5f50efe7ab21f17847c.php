<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"E:\www\phpStudy\WWW\think\public/../application/admin\view\shops\memory.html";i:1498662418;s:77:"E:\www\phpStudy\WWW\think\public/../application/admin\view\public\header.html";i:1498396598;s:77:"E:\www\phpStudy\WWW\think\public/../application/admin\view\public\footer.html";i:1498447740;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<script type="text/javascript">
    ...
    function member_huanyuan(obj,id){
        layer.confirm('确认要还原吗？',function(){
            ...
            var url="<?php echo url('admin/shops/reduciton'); ?>";
            var aid={
                'id':id,
            };
            $.post(url,aid,function(result){
                if(result)
                {
                    location.href="<?php echo url('admin/shops/memory'); ?>";
                }
            },'json');
        });
    }
    ...
    function member_del(obj,id){
        layer.confirm('确认要删除吗？',function(){
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo url('admin/shops/agindel'); ?>",
                data:aid,
                dataType: 'json',
