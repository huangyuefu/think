<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:75:"E:\www\phpStudy\WWW\think\public/../application/admin\view\enter\enter.html";i:1497833690;s:77:"E:\www\phpStudy\WWW\think\public/../application/admin\view\public\header.html";i:1498396598;s:75:"E:\www\phpStudy\WWW\think\public/../application/admin\view\public\menu.html";i:1498546332;s:77:"E:\www\phpStudy\WWW\think\public/../application/admin\view\public\footer.html";i:1498447740;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
			<ul class="cl">
				...
				<li class="dropDown dropDown_hover">
					<a href="#" class="dropDown_A"><?php echo session('admin_user.username'); ?> <i class="Hui-iconfont">&#xe6d5;</i></a>
					<ul class="dropDown-menu menu radius box-shadow">
						<li><a href="javascript:;" onClick="myselfinfo()">个人信息</a></li>
						<li><a href="<?php echo url('admin/enter/change'); ?>">修改密码</a></li>
						<li><a href="<?php echo url('admin/enter/logout'); ?>">退出</a></li>
				</ul>
			</li>
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li><a data-href="<?php echo url('admin/article/article_list'); ?>" data-title="资讯管理" href="javascript:void(0)">资讯管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-picture">
            ...
            <dd>
                <ul>
                    <li><a data-href="<?php echo url('admin/image/image_list'); ?>" data-title="图片管理" href="javascript:void(0)">图片管理</a></li>
                    <li><a data-href="<?php echo url('admin/index/lookmap'); ?>" data-title="地图图片" href="javascript:void(0)">地图图片</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-product">
            ...
            <dd>
                <ul>
                    <li><a data-href="<?php echo url('admin/category/category_list'); ?>" data-title="分类管理" href="javascript:void(0)">分类管理</a></li>
                </ul>
            </dd>
        </dl>
     <!--   <dl id="menu-comments">
        ...
        <dl id="menu-member">
            ...
            <dd>
                <ul>
                    <li><a data-href="<?php echo url('admin/shops/index'); ?>" data-title="商铺列表" href="javascript:;">商铺列表</a></li>
                    <li><a data-href="<?php echo url('admin/shops/memory'); ?>" data-title="删除的会员" href="javascript:;">删除的商铺</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-admin">
            ...
            <dd>
                <ul>
                    <li><a data-href="<?php echo url('admin/user/index'); ?>" data-title="角色管理" href="javascript:void(0)">角色管理</a></li>
