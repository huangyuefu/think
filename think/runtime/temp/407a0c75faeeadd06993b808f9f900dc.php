<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"E:\www\phpStudy\WWW\think\public/../application/admin\view\image\image_update.html";i:1498742958;s:77:"E:\www\phpStudy\WWW\think\public/../application/admin\view\public\header.html";i:1498396598;s:77:"E:\www\phpStudy\WWW\think\public/../application/admin\view\public\footer.html";i:1498447740;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
    <form class="form form-horizontal" action="<?php echo url('admin/image/image_update'); ?>" method="post">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>图片标题：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $result[0]['name']; ?>" placeholder="" id="" name="name">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">链接：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $result[0]['url']; ?>" placeholder="" id="" name="url">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
				...
				<select name="category_id" class="select">
					...
					<option value="<?php echo $vo['id']; ?>" <?php if($vo['id'] == $result[0]['category_id']): ?>selected="selected"<?php endif; ?>><?php echo $vo['cate']; ?></option>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <img style="display: block" id="upload_org_code_img" src="<?php echo $result[0]['image_path']; ?>" width="150" height="150">
...
<script type="text/javascript">
    ...
    /*   function article_save(){
     ...
     //'fileObjName' : 'file',
     // 文件接收服务端。
     server: '<?php echo url("admin/image/image_add"); ?>',
     ...
     $.ajax('<?php echo url('admin/image/image_add'); ?>', {
     method: 'POST',
     data: src,
     dataType:'json'
