<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"E:\www\phpStudy\WWW\think\public/../application/index\view\index\product.html";i:1499135510;s:77:"E:\www\phpStudy\WWW\think\public/../application/index\view\public\header.html";i:1499045915;s:77:"E:\www\phpStudy\WWW\think\public/../application/index\view\public\footer.html";i:1499045700;}*/ ?>
    ...
    <div class="neiye clearfix">
        <div class="neiyeL">
            <div class="banL noel">
                <div class="lanmu">
                    <ul>
                        <li><a href="<?php echo url('index/index/Cooperative'); ?>">合作社介绍</a></li>
                        <li><a href="<?php echo url('index/index/product',['id'=>$product_i[0]['id']]); ?>">产品介绍</a></li>
                        <li><a href="<?php echo url('index/index/technology'); ?>" class="xuanz">技术支持</a></li>
                        <li><a href="<?php echo url('index/index/prospect'); ?>">行业前景</a></li>
                        <li><a href="<?php echo url('index/index/Story'); ?>">致富故事</a></li>
                        <li><a href="<?php echo url('index/index/production'); ?>">生产基地</a></li>
                    </ul>
                </div>
            </div>
            <div class="dianhua">
            ...
            <div class="product">
                <div class="product_top">
                    <div class="product_name">
                        <img src="<?php echo $product_i[0]['image_path']; ?>" width="396" height="277" alt="" />
                    </div>
                    <div class="product_info">
                        <p class="prod_bt"><?php echo $product_i[0]['name']; ?></p>
                        <p>产品类别：	水果及加工品</p>
                        <p>产品规格：	4*500G</p>
                        <p>产品原产地：中江县</p>
                        <p>产品价格：	7500元/吨</p>
                        ...
                        <p class="prod_pad">
                            ...
                            <input name="" type="text" class="prod_tetx" VALUE="1"/>
